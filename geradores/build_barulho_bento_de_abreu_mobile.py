...
OUT = ROOT / "pdf" / "guia-barulho-casa-vizinha-bento-de-abreu-mobile.pdf"
...
class Hero(Flowable):
    ...
    def draw(self):
        ...
        c.setFillColor(colors.white)
        c.setFont(BOLD, 9.2)
        c.drawString(40, 18, "Guia elaborado para os moradores de Bento de Abreu/SP")
        c.restoreState()
...
class CompactContactsCard(Flowable):
    def __init__(self):
        ...
        self.rows = [
            ...
            (
                "Prefeitura Municipal de Bento de Abreu/SP",
                "(18) 3601-9200",
                ["Providências administrativas e fiscalização de posturas"],
                55,
            ),
...
def footer(canvas, doc):
    ...
    canvas.drawCentredString(PAGE_W / 2, 17, "Guia informativo elaborado para a comunidade de Bento de Abreu/SP - compartilhe com seus vizinhos.")
    canvas.restoreState()
...
def build():
    ...
    story += [
        ...
        SectionCard(
            ...
            [
                p("Antes de judicializar o caso, tente uma solução por meio da <b>mediação comunitária</b>. Os moradores podem solicitar atendimento junto ao <b>NUMEC (Núcleo de Mediação Comunitária)</b> da 5ª Companhia da Polícia Militar, sediado em Guararapes."),
        ...
        SectionCard(
            4,
            PALETTE["purple"],
            "Comunique também a Prefeitura de Bento de Abreu",
            [
                ...
                p("A <b>Lei Complementar nº 013/2007 (Código de Posturas)</b> proíbe perturbar o sossego e o bem-estar público ou da vizinhança com ruídos, algazarras, barulhos e sons excessivos. A norma também responsabiliza estabelecimentos por tumultos e ruídos na área externa adjacente em razão de seu funcionamento."),
                callout("<b>Prefeitura de Bento de Abreu:</b> (18) 3601-9200", PALETTE["purple"]),
            ],
        ),
        Spacer(1, 12),
        SectionCard(
        ...
        PlainCard(
            ...
            [
                ...
                bullet("<b>Lei Complementar nº 013/2007</b> (Código de Posturas de Bento de Abreu/SP) - Proíbe perturbar o sossego com ruídos, algazarras, barulhos e sons excessivos."),
                bullet("<b>Lei Municipal nº 1.799/2019</b> - Proíbe fogos de artifício que causem poluição sonora, como estouros e estampidos."),
            ],
            PALETTE["violet_bg"],
