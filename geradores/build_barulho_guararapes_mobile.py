...
OUT = ROOT / "pdf" / "guia-barulho-casa-vizinha-guararapes-mobile.pdf"
...
class Hero(Flowable):
    ...
    def draw(self):
        ...
        c.setFillColor(colors.white)
        c.setFont(BOLD, 9.2)
        c.drawString(40, 18, "Guia elaborado para os moradores de Guararapes/SP")
        c.restoreState()
...
class CompactContactsCard(Flowable):
    def __init__(self):
        ...
        self.rows = [
            ...
            (
                "Prefeitura Municipal de Guararapes/SP",
                "(18) 3606-8000",
...
def footer(canvas, doc):
    ...
    canvas.drawCentredString(PAGE_W / 2, 17, "Guia informativo elaborado para a comunidade de Guararapes/SP - compartilhe com seus vizinhos.")
    canvas.restoreState()
...
def build():
    ...
    story += [
        ...
        SectionCard(
            4,
            PALETTE["purple"],
            "Comunique também a Prefeitura de Guararapes",
            [
                ...
                p("A <b>Lei Municipal nº 1.930/1999 (Sons Urbanos)</b> proíbe perturbar o sossego e o bem-estar público ou da vizinhança com ruídos, algazarras, barulhos e sons excessivos. O <b>Código de Posturas (Lei nº 631/1967)</b> também trata de ruídos, diversões e funcionamento de estabelecimentos."),
                callout("<b>Prefeitura de Guararapes:</b> (18) 3606-8000", PALETTE["purple"]),
            ],
        ),
        Spacer(1, 12),
        SectionCard(
        ...
        PlainCard(
            ...
            [
                ...
                bullet("<b>Lei Municipal nº 1.930/1999</b> (Sons Urbanos de Guararapes/SP) - Proíbe perturbar o sossego com ruídos, algazarras, barulhos e sons excessivos."),
                bullet("<b>Lei Municipal nº 631/1967</b> (Código de Posturas de Guararapes/SP) - Trata de ruídos, diversões, licenças e funcionamento de estabelecimentos."),
            ],
            PALETTE["violet_bg"],
